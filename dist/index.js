...
class ConfigLoader {
    constructor() {
        ...
        filePaths.push(path.join(__dirname, 'default'));
        filePaths.push(path.join(__dirname, this.environment));
    ...
    loadConfigData(name) {
        let envFilePath = path.join(__dirname, this.environment, name), defaultPath = path.join(__dirname, 'default', name), data = {};
